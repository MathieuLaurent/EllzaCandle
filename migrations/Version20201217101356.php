 ...
 */
final class Version20201217101356 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commandes (id INT AUTO_INCREMENT NOT NULL, user_cmd_id INT NOT NULL, quantite INT NOT NULL, total INT NOT NULL, INDEX IDX_35D4282C161608E0 (user_cmd_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
